using AspireContainerStarter.Calc1Worker.Workers;
...
// Consumer: reads Calc1JobMessage from the calc1-jobs queue.
...
builder.Services.AddAzureServiceBusConsumerWithManagedIdentity<
    ...
    queueName: builder.Configuration["ServiceBus:Calc1Queue"] ?? "calc1-jobs");
